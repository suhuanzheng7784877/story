...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<!-- 特殊业务js 该页面对应的js文件 -->
		<script type="text/javascript" src="topicManager.js">
</script>
	</head>
	<style type="text/css">
.style1 {
					...
					<table width="100%" id="tdiv" border="0" cellspacing="0"
						...
						<tr>
							...
							<td colspan="4" width="25%" align="left"
								...
								<input type="text" name="topicTitle" id="topicTitle" maxlength="8"
						...
						<tr>
							...
							<td colspan="4" width="25%" align="left"
								style="border-bottom: 1px solid #A9C8D9;">
								<input type="text" name="topicIntro" id="topicIntro" maxlength="8"
									onpropertychange="TextUtil.NotMax(this)"
									class="textclass required"></input>
								<label class="addred"></label>
							</td>
