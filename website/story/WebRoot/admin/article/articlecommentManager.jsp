...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<!-- 特殊业务js 该页面对应的js文件 -->
		<script type="text/javascript" src="articlecommentManager.js">
</script>
					...
					<table width="100%" id="tdiv" border="0" cellspacing="0"
						...
						<tr>
							...
							<td width="25%" align="left" colspan="3"
								...
								<input type="text" name="commentMessage" id="commentMessage" maxlength="30"
					...
					<table width="100%" id="tdiv" border="0" cellspacing="0"
						...
						<tr>
							...
							<td width="25%" align="left"
								style="border-bottom: 1px solid #A9C8D9;">
								<input type="text" name="nameInfo" id="nameInfo" maxlength="30"
									onpropertychange="TextUtil.NotMax(this)"
									class="textclass required"></input>
								<label class="addred"></label>
							</td>
							...
							<td width="25%" align="left"
								style="border-bottom: 1px solid #A9C8D9;">
								<input type="text" name="isPassInfo" id="isPassInfo"
									maxlength="30" onpropertychange="TextUtil.NotMax(this)"
									class="textclass required"></input>
								<label class="addred"></label>
							</td>
