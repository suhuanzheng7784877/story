...
function openGridJson() {
	...
	jQuery("#editgrid").jqGrid(
			{
				url : "../../bbsinvitation/showInvitationcomment.action",
				datatype : "json",
				colNames : [ '操作', '主键', '贴子标题', '评论人','评论日期', '评论内容' ],
				colModel : [ {
					name : 'viewOperation',
					index : 'viewOperation',
					sortable : false,
...
function serchObjectSubmit() {
	...
	var requestUrl = basePath + "/bbsinvitation/searchinvitationComments.action?" + con;
	//更改url重新加载
