			...
			<div class="row" style="padding: 10px 0;">
				...
				<div class="span70">
					<div class="row">
						<div class="span69">
							<div class="manageBar">
								<a href="/login">登录</a><span class="pipe">|</span><a
						...
						<div class="row mar_10">
							<div class="span35" style="float: left;">
								<div class="list_box">
									<h2 class="hd">
										<span><a href="/announcement/start" title="更多">更多&gt;&gt;</a>
										</span><font>综合</font>新闻
									</h2>
									<ul class="list">
										<li>
											<span class="pull-right timeago" title="2013-01-31 23:49"></span><a
												href="/ann/announcement/583" target="_blank"
												title="中华英才网的覆灭：自杀式改版与被动挨打">中华英才网的覆灭：自杀式改版与被动挨打</a>
										</li>
										<li>
											<span class="pull-right timeago" title="2013-01-28 11:37"></span><a
												href="/ann/announcement/582" target="_blank"
												title="互联网公司&nbsp;请裁掉无线部门！">互联网公司&nbsp;请裁掉无线部门！</a>
										</li>
										<li>
											<span class="pull-right timeago" title="2013-01-28 11:35"></span><a
												href="/ann/announcement/581" target="_blank"
												title="jsoup&nbsp;1.7.2&nbsp;发布，支持&nbsp;CSS&nbsp;类伪码选择器">jsoup&nbsp;1.7.2&nbsp;发布，支持&nbsp;CSS&nbsp;类伪码选择器</a>
										</li>
										<li>
											<span class="pull-right timeago" title="2013-01-23 10:04"></span><a
												href="/ann/announcement/580" target="_blank"
												title="GitLab&nbsp;4.1&nbsp;增加用户注册页和公有库">GitLab&nbsp;4.1&nbsp;增加用户注册页和公有库</a>
										</li>
										<li>
											<span class="pull-right timeago" title="2013-01-22 09:26"></span><a
												href="/ann/announcement/579" target="_blank"
												title="互联网手机已死？那些不靠谱的安卓皮手机们">互联网手机已死？那些不靠谱的安卓皮手机们</a>
										</li>
										<li>
											<span class="pull-right timeago" title="2013-01-21 10:00"></span><a
												href="/ann/announcement/578" target="_blank"
												title="Hibernate&nbsp;Search&nbsp;4.2&nbsp;正式版发布">Hibernate&nbsp;Search&nbsp;4.2&nbsp;正式版发布</a>
										</li>
										<li>
											<span class="pull-right timeago" title="2013-01-19 13:21"></span><a
												href="/ann/announcement/577" target="_blank"
												title="Node.js&nbsp;0.8.18&nbsp;/&nbsp;0.9.7&nbsp;发布">Node.js&nbsp;0.8.18&nbsp;/&nbsp;0.9.7&nbsp;发布</a>
										</li>
										<li>
											<span class="pull-right timeago" title="2013-01-17 09:48"></span><a
												href="/ann/announcement/576" target="_blank"
												title="Spring&nbsp;的下一个版本&nbsp;——&nbsp;4.0&nbsp;！">Spring&nbsp;的下一个版本&nbsp;——&nbsp;4.0&nbsp;！</a>
										</li>
										<li>
											<span class="pull-right timeago" title="2013-01-16 09:05"></span><a
												href="/ann/announcement/575" target="_blank"
												title="马云辞任CEO专任阿里董事局主席&nbsp;5月任命新CEO">马云辞任CEO专任阿里董事局主席&nbsp;5月任命新CEO</a>
										</li>
										<li>
											<span class="pull-right timeago" title="2013-01-16 09:01"></span><a
												href="/ann/announcement/574" target="_blank"
												title="jQuery&nbsp;1.9&nbsp;正式版发布">jQuery&nbsp;1.9&nbsp;正式版发布</a>
										</li>
									</ul>
								</div>
							</div>
							...
							<div class="span71" style="float: left;">
								<div class="list_box">
									<h2 class="hd">
										...
										</span><font>最新</font>博客
									</h2>
									<dl class="list">
										<dt>
											<span class="pull-right timeago" title="2013-02-01 22:12"></span><a
												href="/blog/article/714" target="_blank"
												title="分析jQuery创建实例与原型继承是怎么处理的">分析jQuery创建实例与原型继承是怎么处理的</a>
										</dt>
										<dd>

											在普通情况下我们要用原生类、或者自定义类创建实例要用new运算符，使构造函数创建一个实例，并且实例继承构造器prototype上的所有公有方法。如
											new Object()、new Date()等等！（object有{}，数组有...
										</dd>
										<dt>
											<span class="pull-right timeago" title="2013-02-01 18:41"></span><a
												href="/blog/article/713" target="_blank" title="蛇年祝福语">蛇年祝福语</a>
										</dt>
										<dd>

											没什么好说的我不知道对你还有什么话要说有些事咱们相互心里明晰就行了可是新年就到了我不得不把话挑明提前给你拜年了我的红包呢

											一串串鞭炮打开快乐一盏盏灯笼充满喜庆一家家团圆火热欢笑一声声祝福嵌满真情。新年第一...
										</dd>
										<dt>
											<span class="pull-right timeago" title="2013-02-01 00:24"></span><a
												href="/blog/article/712" target="_blank"
												title="仿微博字符统计和本地存储功能的实现">仿微博字符统计和本地存储功能的实现</a>
										</dt>
										<dd>
										...
										<dt>
											<span class="pull-right timeago" title="2013-01-31 14:02"></span><a
												href="/blog/article/711" target="_blank"
												title="正则表达式split注意">正则表达式split注意</a>
										</dt>
										<dd>
											1234567 public static void main(String[] args) { String value
											= "192.168.128.33"; String[] names = val...
										</dd>
										<dt>
											<span class="pull-right timeago" title="2013-01-23 10:20"></span><a
												href="/blog/article/710" target="_blank"
												title="关于java中的interface接口">关于java中的interface接口</a>
										</dt>
										<dd>
								...
								<div class="control-group">
									...
									<div class="controls" >
										<input type="text" name="username" id="l_username"
											...
											msg="用户名输入有误：<br/>">
										<input name="url" type="hidden" id="l_url" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="l_password0">
										密码
									</label>
									<div class="controls" >
										<input type="password" name="password0" id="l_password0"
											placeholder="密码" maxlength="20"
											regex="[a-zA-Z0-9\~\!\@\#\$\%\^\&\*\(\)\_\+\`\-\=\{\}\[\]\:\;\'\&quot;\<\>\?\,\.\/ ]{6,20}"
											msg="口令输入有误：<br/>">
										<input name="password" type="hidden" id="l_password" />
									</div>
								</div>
								<div class="control-group">
									<div class="controls">
										<label class="checkbox">
											<input name="rememberMe" type="checkbox" id="l_rememberMe"
												checked="checked" value="true" style="width: 30px;">
											记住我
										</label>
