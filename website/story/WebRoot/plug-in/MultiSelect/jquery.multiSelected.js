...
if(jQuery) (function($){
	...
	$.extend($.fn, {
		multiSelected: function(o, callback,id,symbol,str) {
			// Default options
			if( !o ) var o = {};
			...
			$(this).each( function() {
				...
				if( o.selectAll ) html += '<label class="selectAll"><input check="checked" type="checkbox" class="selectAll" />' + o.selectAllText + '</label>';
				$(select).find('OPTION').each( function() {
					if( $(this).val() != '' ) {
						html += '<label><input checked="checked" type="checkbox" name="' + $(select).attr('name') + '" value="' + $(this).val() + '"';
			...
			if( i == 0 ) {
				...
				if( o.oneOrMoreSelected == '*' ) {
					...
					$(this).find('INPUT:checkbox:checked').each( function() {
						if( $(this).parent().text() != o.selectAllText ) display = display + $(this).parent().text() + symbol+' ';
					});
