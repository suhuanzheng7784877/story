		...
		switch ( GetE('cmbLinkType').value )
		{
			...
			case 'url':
				...
				if (asLinkPath != null)
					...
					var dotnum = asLinkPath[1].lastIndexOf('\/');//str '/'s num 
					var filename = asLinkPath[1].substring(dotnum+1,asLinkPath[1].length);//substring the str to get filename
					sInnerHtml = filename;//to value
				break ;
