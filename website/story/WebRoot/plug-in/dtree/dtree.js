...
function dTree(objName, appPath) {
	...
	this.icon = {
		...
		root : appPath + '/plug-in/dtree/img/17.gif',

		folder : appPath + '/plug-in/dtree/img/folder.gif',

		folderOpen : appPath + '/plug-in/dtree/img/folderopen.gif',

		node : appPath + '/plug-in/dtree/img/page.gif',

		empty : appPath + '/plug-in/dtree/img/empty.gif',

		line : appPath + '/plug-in/dtree/img/line.gif',

		join : appPath + '/plug-in/dtree/img/join.gif',

		joinBottom : appPath + '/plug-in/dtree/img/joinbottom.gif',

		plus : appPath + '/plug-in/dtree/img/plus.gif',

		plusBottom : appPath + '/plug-in/dtree/img/plusbottom.gif',

		minus : appPath + '/plug-in/dtree/img/minus.gif',

		minusBottom : appPath + '/plug-in/dtree/img/minusbottom.gif',

		nlPlus : appPath + '/plug-in/dtree/img/nolines_plus.gif',

		nlMinus : appPath + '/plug-in/dtree/img/nolines_minus.gif'
...
function selChildNode(chkboxId) {
	try {
		// get node id
...
function getCheckedboxIds() {
	try {
		...
		//alert("some error getids occurs!");
	}
}
//lcq
...
dTree.prototype.node = function(node, nodeId) {
	...
	if (this.config.useCheckBox && nodeId != 0) {
		str += '<input type="checkbox" name="dTreeChk" style="VERTICAL-ALIGN:middle; WIDTH:11px; HEIGHT:11px" id="'
				+ node.id
				+ "$#"
				+ node.pid
				+ '" onclick=selChildNode("'
				+ node.id + "$#" + node.pid + '") />';
	}
	//lcq
