...
public class Invokers {
	...
	private static String argumentTypesToString(Class<?>[] argTypes) {
		...
		buf.append("(");
		if (argTypes != null) {
			int argTypesLength = argTypes.length;
	...
	public static Invoker newInvoker(Method method) {
		...
		if (invoker == null) {
			StringBuilder proxyClassNameBuilder = new StringBuilder(64);
			...
			try {
				...
				try {
					...
					cc
							.addMethod(CtMethod
									.make(
											"public java.lang.reflect.Method method(){return m;}",
											cc));
					StringBuilder invokeCode = new StringBuilder(64);
					invokeCode
							.append("public Object invoke(Object host, Object[] args){");
					StringBuilder parameterCode = new StringBuilder(64);
					...
					StringBuilder executeCode = new StringBuilder(64);
		...
		try {
			...
			try {
				...
				for (Method method : methods) {
					...
					StringBuilder methodCode = new StringBuilder(64);
					StringBuilder paramCode = new StringBuilder(32);
