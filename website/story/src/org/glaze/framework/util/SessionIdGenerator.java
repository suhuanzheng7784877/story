...
public class SessionIdGenerator {
	 ...
	 */
	private static Queue<SecureRandom> randoms = new ConcurrentLinkedQueue<SecureRandom>();
	...
	/**
	 * 生成UUID主键,很慢，但是保证无重复ID数据
	 * 
	 * @return
	 */
	public final static String generateStringPK() {
		UUID uuid = UUID.randomUUID();
		String uuidString = uuid.toString();
		String[] uuids = uuidString.split("-");
		StringBuilder pk = new StringBuilder(32);
		for (String id : uuids) {
			pk.append(id);
		}
		return pk.toString();
