...
public class ArticleRefreshIndex extends AbstractRefreshIndex {

	public Logger logger = Logger.getLogger(ArticleRefreshIndex.class);
	...
	protected Document buildDocument(ResultSet resultSet) {
		...
		Field contentField = new Field("content", content, Store.YES,
				Index.ANALYZED);
